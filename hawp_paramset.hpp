...
namespace wavepackets {
    ...
    */
    ...
    {
    private:
        RMatrix<D,1> q_, p_;   //q and p
        CMatrix<D,D> Q_, P_;   //Q and P
        complex_t S_;          //global phase 
        math::ContinuousSqrt<real_t> sqrt_detQ_;  //the continuousSqrt
    ...
    public:
        ...
        *  See Algorithm 10 Mixing two set II_r and II_c of Hagedorn parameters 
        */
