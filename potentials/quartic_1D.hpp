...
{
    /**
    * \brief This class represents 1D quartic oscillator V(x)=\frac{\sigma{x}^4}{4}
    *
    * \tparam D dimensionality of 1D quartic oscillator(number of variables)
    */
	...
	struct Quartic_1D
	{
        ...
        Quartic_1D()= default;  // default constructor 

        Quartic_1D(real_t sigma, const RMatrixDD &mass_inv): sigma_(sigma), mass_inv_(mass_inv) {}  //constructor 

        //copy constructor 
        Quartic_1D(const Quartic_1D &that){
        ...
        //assignment 
        Quartic_1D &operator=(const Quartic_1D& that){
        ...
        /**
        * \brief calculate the value of 1D quartic oscillator at position pos
        * \param[in] pos  the position at which we calculate the value of 1D quartic oscillator
        */

    	real_t evaluate_pes(const RMatrixD1& pos) const 
    	{
            return sigma_*pos(0)*pos(0)*pos(0)*pos(0)/4.0;
    	}



        /**
        * \brief calculate the gradient of 1D quartic oscillator at position pos 
        * \param[in] pos the position at which we calculate the gradient of 1D quartic oscillator
        */
    	...
    	RMatrixD1 evaluate_grad(const RMatrixD1& pos) const 
    	{
            ...
            grad(0)=sigma_* pos(0)*pos(0)*pos(0);

            return grad;
    	}

        /**
        * \brief calculate the hessian of 1D quartic oscillator at position pos 
        * \param[in] pos the position at which we calculate the 1D quartic oscillator
        */
    	...
    	RMatrixDD evaluate_hess(const RMatrixD1& pos) const 
    	{
            ...
            hess(0,0)=3.0*sigma_*pos(0)*pos(0);
        ...
        * \param[in] nodes the quadrature points at which we calculate the values of 1D quartic oscillator
        */
